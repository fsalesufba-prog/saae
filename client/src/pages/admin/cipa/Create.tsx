...
const CipaCreate: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/cipa', formData);
      navigate('/admin/cipa');
    } catch (err: any) {
      setError(err.response?.data?.error || 'Erro ao criar seção');
    } finally {
      setLoading(false);
    }
  };
