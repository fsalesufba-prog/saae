...
const WaterQualityCreate: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.post('/water-quality', data, {
        headers: {
      ...
      setError(err.response?.data?.error || 'Erro ao criar relatório');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="water-quality-page">
      <div className="page-header">
        <h1>Novo Relatório de Qualidade da Água</h1>
      </div>
...
export default WaterQualityCreate;